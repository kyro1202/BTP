// Program to print all paths with congestion to test it against our algorithm
...
int main() 
{
	...
	E.clear();
	int u,v,temp = n;
    double dis,congestion;
	for(int i = 0 ; i < m ; i++)
	{
		cin >> u >> v >> dis >> congestion;
		for(int l = 0 ; l < 4 ; l++)
		{
			if((l+1)*20.0 > congestion)
				break;
